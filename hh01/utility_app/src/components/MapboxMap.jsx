export default function MapboxMap({ center = [34.05, -118.24], zoom = 10, height = 300 }) {
  ...
  if (!MAPBOX_TOKEN) {
    return (
      <div style={{ width: '100%', height: h, background: '#0d1928', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <span style={{ color: '#64748b', fontSize: 14 }}>Map unavailable — set VITE_MAPBOX_TOKEN</span>
      </div>
    );
  }
